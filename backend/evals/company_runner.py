"""Run Agent 3 against real research output and score process quality.
    ...
    python -m backend.evals.company_runner
    python -m backend.evals.company_runner --case semiconductors_high_risk
    python -m backend.evals.company_runner --limit 2      # fewer profiles, less quota
    python -m backend.evals.company_runner --delay 90     # slower, if rate limited
