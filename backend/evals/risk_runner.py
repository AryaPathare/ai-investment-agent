"""Run Agent 4 against real Agent 3 output and score process quality.
    ...
    python -m backend.evals.risk_runner
    python -m backend.evals.risk_runner --case semiconductors_high_risk
    python -m backend.evals.risk_runner --limit 2      # fewer profiles, less quota
