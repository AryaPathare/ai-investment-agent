"""Run Agent 2 against the eval profiles and score process quality.
    ...
    python -m backend.evals.research_runner
    python -m backend.evals.research_runner --case renewables_excluding_fossil_fuels
    python -m backend.evals.research_runner --no-url-check     # skip live URL checks
    python -m backend.evals.research_runner --delay 90         # slower, if rate limited
