"""Run Agent 5 against real output from the whole pipeline and score it.
    ...
    python -m backend.evals.decision_runner
    python -m backend.evals.decision_runner --case banking_excluding_crypto
    python -m backend.evals.decision_runner --limit 1     # the most expensive eval here
...
from backend.agents.decide_agent import KNOWN_METRICS
from backend.agents.selection import restriction_terms
from backend.config import PROJECT_ROOT
from backend.evals.research_cases import CASES, ResearchCase
from backend.models.companies import CompanyFindings
from backend.models.decision import MAX_RECOMMENDATIONS, Decision
...
def main() -> int:
    ...
    from backend.agents.research_agent import research_themes
